...
public class LoadImageAndScale extends JApplet 
{
   ...
   public void init()
   {
      image1 = getImage( getClass().getResource( "redflowers.png" ) ); //getDocumentBase(), "redflowers.png" );
      image2 = new ImageIcon( getClass().getResource( "redflowers.png" ) ); //"yellowflowers.png" );
   } // end method init
